...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // verify the commmand is in fact a command
        ...
        // read cooldowns for commands and check if the command is on cooldown for the interaction.user.id
